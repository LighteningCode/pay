...
function Navbar() {
    return (
        <nav className="flex flex-row mt-3 pl-5">
            <section className="mr-auto flex flex-row">
                <figure className="mr-16">
                    <p className="font-extrabold  text-2xl">Pay</p>
                </figure>
                ...
                <div className="bg-white rounded-2xl px-4 pb-1 pt-1 focus:outline-none text-gray-400 flex flex-row">
                    ...
                    <input style={{fontSize:"10px"}} placeholder="Search" className="text-sm pl-2 w-44" value={null} />
                </div>
            </section>
