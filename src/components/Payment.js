...
function Payment (props) {
    return (
        <div style={{height:"83.3%"}} className="bg-gray-100 rounded-3xl justify-center flex flex-col px-4 pt-6 pb-6 md:mx-1 mx-3 transition-all duration-500 w-full border-2 hover:border-black">
